...
"""autogenerated by genpy from iv_dynamicobject_msgs/TargetCar.msg. Do not edit."""
import sys
...
class TargetCar(genpy.Message):
  ...
  _type = "iv_dynamicobject_msgs/TargetCar"
...
"""
  ...
  _slot_types = ['iv_dynamicobject_msgs/Rectangle[]','int32']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = iv_dynamicobject_msgs.msg.Rectangle()
        _v5 = val1.Point1
        _x = _v5
        start = end
        end += 24
