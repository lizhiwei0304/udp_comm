...
class Lanelet(genpy.Message):
  _md5sum = "79efb21963470ed788ab90e3dd311d0e"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_8bd().pack(_x.left_bound.is_forward, _x.left_bound.open_concave_obs_det, _x.left_bound.open_dynamic_obs_det, _x.left_bound.open_foggy_det, _x.left_bound.open_water_det, _x.left_bound.foggy_area, _x.left_bound.lawn_area, _x.left_bound.water_area, _x.left_bound.vel_limit))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_8bd().pack(_x.right_bound.is_forward, _x.right_bound.open_concave_obs_det, _x.right_bound.open_dynamic_obs_det, _x.right_bound.open_foggy_det, _x.right_bound.open_water_det, _x.right_bound.foggy_area, _x.right_bound.lawn_area, _x.right_bound.water_area, _x.right_bound.vel_limit))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_8bd().pack(_x.centerline.is_forward, _x.centerline.open_concave_obs_det, _x.centerline.open_dynamic_obs_det, _x.centerline.open_foggy_det, _x.centerline.open_water_det, _x.centerline.foggy_area, _x.centerline.lawn_area, _x.centerline.water_area, _x.centerline.vel_limit))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.left_bound.is_forward, _x.left_bound.open_concave_obs_det, _x.left_bound.open_dynamic_obs_det, _x.left_bound.open_foggy_det, _x.left_bound.open_water_det, _x.left_bound.foggy_area, _x.left_bound.lawn_area, _x.left_bound.water_area, _x.left_bound.vel_limit,) = _get_struct_8bd().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.right_bound.is_forward, _x.right_bound.open_concave_obs_det, _x.right_bound.open_dynamic_obs_det, _x.right_bound.open_foggy_det, _x.right_bound.open_water_det, _x.right_bound.foggy_area, _x.right_bound.lawn_area, _x.right_bound.water_area, _x.right_bound.vel_limit,) = _get_struct_8bd().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.centerline.is_forward, _x.centerline.open_concave_obs_det, _x.centerline.open_dynamic_obs_det, _x.centerline.open_foggy_det, _x.centerline.open_water_det, _x.centerline.foggy_area, _x.centerline.lawn_area, _x.centerline.water_area, _x.centerline.vel_limit,) = _get_struct_8bd().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
