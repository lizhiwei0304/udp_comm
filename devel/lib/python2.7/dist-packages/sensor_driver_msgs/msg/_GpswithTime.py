...
"""autogenerated by genpy from sensor_driver_msgs/GpswithTime.msg. Do not edit."""
import sys
...
class GpswithTime(genpy.Message):
  _md5sum = "4a9d103fb5b90d7927287e95289cb45b"
  _type = "sensor_driver_msgs/GpswithTime"
...
uint16 service
"""
  __slots__ = ['gps','heading','roll','pitch','time']
  _slot_types = ['sensor_msgs/NavSatFix','float32','float32','float32','int64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GpswithTime, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B3fq().pack(_x.gps.position_covariance_type, _x.heading, _x.roll, _x.pitch, _x.time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps.position_covariance_type, _x.heading, _x.roll, _x.pitch, _x.time,) = _get_struct_B3fq().unpack(str[start:end])
      return self
...
def _get_struct_9d():
    ...
    return _struct_9d
_struct_B3fq = None
def _get_struct_B3fq():
    global _struct_B3fq
    if _struct_B3fq is None:
        _struct_B3fq = struct.Struct("<B3fq")
    return _struct_B3fq
