...
"""autogenerated by genpy from sensor_driver_msgs/PointCloudMultiLaser.msg. Do not edit."""
import sys
...
class PointCloudMultiLaser(genpy.Message):
  _md5sum = "af429b8dd0128bd96a7bacec1ffd7da7"
  _type = "sensor_driver_msgs/PointCloudMultiLaser"
...
"""
  __slots__ = ['lasernum','lidarid','laseridmap','laseranglemap','pointcloud']
  _slot_types = ['int16','int16','int16[]','float32[]','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       lasernum,lidarid,laseridmap,laseranglemap,pointcloud
    ...
    """
    if args or kwds:
      super(PointCloudMultiLaser, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.lasernum is None:
        self.lasernum = 0
      if self.lidarid is None:
        self.lidarid = 0
      if self.laseridmap is None:
        self.laseridmap = []
      if self.laseranglemap is None:
        self.laseranglemap = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.laseridmap)
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.laseridmap))
      length = len(self.laseranglemap)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.laseranglemap))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.laseridmap = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.laseranglemap = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(self.laseridmap.tostring())
      length = len(self.laseranglemap)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.laseranglemap.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.pointcloud.header.seq, _x.pointcloud.header.stamp.secs, _x.pointcloud.header.stamp.nsecs))
      _x = self.pointcloud.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.laseridmap = numpy.frombuffer(str[start:end], dtype=numpy.int16, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.laseranglemap = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.pointcloud.header.seq, _x.pointcloud.header.stamp.secs, _x.pointcloud.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
