...
(cl:defclass <TargetCar> (roslisp-msg-protocol:ros-message)
  ((CarPosition
    :reader CarPosition
    :initarg :CarPosition
    :type (cl:vector iv_dynamicobject_msgs-msg:Rectangle)
   :initform (cl:make-array 0 :element-type 'iv_dynamicobject_msgs-msg:Rectangle :initial-element (cl:make-instance 'iv_dynamicobject_msgs-msg:Rectangle)))
   (num
    :reader num
    :initarg :num
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <TargetCar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetCar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_dynamicobject_msgs-msg:<TargetCar> is deprecated: use iv_dynamicobject_msgs-msg:TargetCar instead.")))

(cl:ensure-generic-function 'CarPosition-val :lambda-list '(m))
(cl:defmethod CarPosition-val ((m <TargetCar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:CarPosition-val is deprecated.  Use iv_dynamicobject_msgs-msg:CarPosition instead.")
  (CarPosition m))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <TargetCar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:num-val is deprecated.  Use iv_dynamicobject_msgs-msg:num instead.")
  (num m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TargetCar>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'CarPosition)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'iv_dynamicobject_msgs-msg:Rectangle))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TargetCar>)))
  ...
  "iv_dynamicobject_msgs/TargetCar")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TargetCar)))
  "Returns string type for a message object of type 'TargetCar"
  "iv_dynamicobject_msgs/TargetCar")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TargetCar>)))
  ...
  (cl:format cl:nil "Rectangle[] CarPosition~%int32 num~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Rectangle~%Points Point1~%Points Point2~%Points Point3~%Points Point4~%float64 Height~%int32 Heading~%int32 Id_number~%float64 v_x~%float64 v_y~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TargetCar)))
  "Returns full string definition for message of type 'TargetCar"
  (cl:format cl:nil "Rectangle[] CarPosition~%int32 num~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Rectangle~%Points Point1~%Points Point2~%Points Point3~%Points Point4~%float64 Height~%int32 Heading~%int32 Id_number~%float64 v_x~%float64 v_y~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
