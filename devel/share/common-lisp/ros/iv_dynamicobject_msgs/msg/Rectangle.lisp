...
(cl:defmethod cl:initialize-instance :after ((m <Rectangle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rectangle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_dynamicobject_msgs-msg:<Rectangle> is deprecated: use iv_dynamicobject_msgs-msg:Rectangle instead.")))

(cl:ensure-generic-function 'Point1-val :lambda-list '(m))
(cl:defmethod Point1-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Point1-val is deprecated.  Use iv_dynamicobject_msgs-msg:Point1 instead.")
  (Point1 m))

(cl:ensure-generic-function 'Point2-val :lambda-list '(m))
(cl:defmethod Point2-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Point2-val is deprecated.  Use iv_dynamicobject_msgs-msg:Point2 instead.")
  (Point2 m))

(cl:ensure-generic-function 'Point3-val :lambda-list '(m))
(cl:defmethod Point3-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Point3-val is deprecated.  Use iv_dynamicobject_msgs-msg:Point3 instead.")
  (Point3 m))

(cl:ensure-generic-function 'Point4-val :lambda-list '(m))
(cl:defmethod Point4-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Point4-val is deprecated.  Use iv_dynamicobject_msgs-msg:Point4 instead.")
  (Point4 m))

(cl:ensure-generic-function 'Height-val :lambda-list '(m))
(cl:defmethod Height-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Height-val is deprecated.  Use iv_dynamicobject_msgs-msg:Height instead.")
  (Height m))

(cl:ensure-generic-function 'Heading-val :lambda-list '(m))
(cl:defmethod Heading-val ((m <Rectangle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:Heading-val is deprecated.  Use iv_dynamicobject_msgs-msg:Heading instead.")
  (Heading m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rectangle>)))
  ...
  "iv_dynamicobject_msgs/Rectangle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rectangle)))
  "Returns string type for a message object of type 'Rectangle"
  "iv_dynamicobject_msgs/Rectangle")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Rectangle>)))
  ...
  (cl:format cl:nil "Points Point1~%Points Point2~%Points Point3~%Points Point4~%float64 Height~%int32 Heading~%int32 Id_number~%float64 v_x~%float64 v_y~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Rectangle)))
  "Returns full string definition for message of type 'Rectangle"
  (cl:format cl:nil "Points Point1~%Points Point2~%Points Point3~%Points Point4~%float64 Height~%int32 Heading~%int32 Id_number~%float64 v_x~%float64 v_y~%~%================================================================================~%MSG: iv_dynamicobject_msgs/Points~%float64 x~%float64 y~%float64 z~%~%~%"))
