...
(cl:defmethod cl:initialize-instance :after ((m <Points>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Points)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_dynamicobject_msgs-msg:<Points> is deprecated: use iv_dynamicobject_msgs-msg:Points instead.")))
...
(cl:defmethod z-val ((m <Points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_dynamicobject_msgs-msg:z-val is deprecated.  Use iv_dynamicobject_msgs-msg:z instead.")
  (z m))
