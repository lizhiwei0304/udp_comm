...
(cl:defclass <TrajectoryOptions> (roslisp-msg-protocol:ros-message)
  ((tracking_frame
   ...
   (use_lidar_odometry_withgps
    :reader use_lidar_odometry_withgps
    :initarg :use_lidar_odometry_withgps
    :type cl:boolean
    :initform cl:nil)
   (num_laser_scans
   ...
   (num_point_clouds
    ...
    :initform 0)
   (wiping_movingtaget
    :reader wiping_movingtaget
    :initarg :wiping_movingtaget
    :type cl:boolean
    :initform cl:nil)
...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryOptions>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryOptions)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-msg:<TrajectoryOptions> is deprecated: use iv_slam_ros_msgs-msg:TrajectoryOptions instead.")))

(cl:ensure-generic-function 'tracking_frame-val :lambda-list '(m))
(cl:defmethod tracking_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:tracking_frame-val is deprecated.  Use iv_slam_ros_msgs-msg:tracking_frame instead.")
  (tracking_frame m))

(cl:ensure-generic-function 'published_frame-val :lambda-list '(m))
(cl:defmethod published_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:published_frame-val is deprecated.  Use iv_slam_ros_msgs-msg:published_frame instead.")
  (published_frame m))

(cl:ensure-generic-function 'odom_frame-val :lambda-list '(m))
(cl:defmethod odom_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:odom_frame-val is deprecated.  Use iv_slam_ros_msgs-msg:odom_frame instead.")
  (odom_frame m))

(cl:ensure-generic-function 'provide_odom_frame-val :lambda-list '(m))
(cl:defmethod provide_odom_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:provide_odom_frame-val is deprecated.  Use iv_slam_ros_msgs-msg:provide_odom_frame instead.")
...
(cl:defmethod use_odometry-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:use_odometry-val is deprecated.  Use iv_slam_ros_msgs-msg:use_odometry instead.")
  (use_odometry m))

(cl:ensure-generic-function 'use_lidar_odometry_withgps-val :lambda-list '(m))
(cl:defmethod use_lidar_odometry_withgps-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:use_lidar_odometry_withgps-val is deprecated.  Use iv_slam_ros_msgs-msg:use_lidar_odometry_withgps instead.")
  (use_lidar_odometry_withgps m))

(cl:ensure-generic-function 'num_laser_scans-val :lambda-list '(m))
(cl:defmethod num_laser_scans-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:num_laser_scans-val is deprecated.  Use iv_slam_ros_msgs-msg:num_laser_scans instead.")
  (num_laser_scans m))
...
(cl:defmethod num_multi_echo_laser_scans-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:num_multi_echo_laser_scans-val is deprecated.  Use iv_slam_ros_msgs-msg:num_multi_echo_laser_scans instead.")
...
(cl:defmethod num_subdivisions_per_laser_scan-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:num_subdivisions_per_laser_scan-val is deprecated.  Use iv_slam_ros_msgs-msg:num_subdivisions_per_laser_scan instead.")
...
(cl:defmethod num_point_clouds-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:num_point_clouds-val is deprecated.  Use iv_slam_ros_msgs-msg:num_point_clouds instead.")
  (num_point_clouds m))

(cl:ensure-generic-function 'wiping_movingtaget-val :lambda-list '(m))
(cl:defmethod wiping_movingtaget-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:wiping_movingtaget-val is deprecated.  Use iv_slam_ros_msgs-msg:wiping_movingtaget instead.")
  (wiping_movingtaget m))
...
(cl:defmethod trajectory_builder_options_proto-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:trajectory_builder_options_proto-val is deprecated.  Use iv_slam_ros_msgs-msg:trajectory_builder_options_proto instead.")
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrajectoryOptions>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'use_lidar_odometry_withgps) 1 0)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'wiping_movingtaget) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryOptions>) istream)
  "Deserializes a message object of type '<TrajectoryOptions>"
    ...
    (cl:setf (cl:slot-value msg 'use_lidar_odometry_withgps) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((unsigned 0))
    ...
    (cl:setf (cl:slot-value msg 'wiping_movingtaget) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryOptions>)))
  ...
  "iv_slam_ros_msgs/TrajectoryOptions")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryOptions)))
  "Returns string type for a message object of type 'TrajectoryOptions"
  "iv_slam_ros_msgs/TrajectoryOptions")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectoryOptions>)))
  ...
  "ff6a016b854fdd87b31800cde39bbf6a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectoryOptions)))
  "Returns md5sum for a message object of type 'TrajectoryOptions"
  "ff6a016b854fdd87b31800cde39bbf6a")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TrajectoryOptions>))
  ...
  (cl:list 'TrajectoryOptions
    ...
    (cl:cons ':use_lidar_odometry_withgps (use_lidar_odometry_withgps msg))
    ...
    (cl:cons ':wiping_movingtaget (wiping_movingtaget msg))
