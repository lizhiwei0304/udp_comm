...
(cl:defmethod cl:initialize-instance :after ((m <SubmapEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-msg:<SubmapEntry> is deprecated: use iv_slam_ros_msgs-msg:SubmapEntry instead.")))
...
(cl:defmethod submap_version-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:submap_version-val is deprecated.  Use iv_slam_ros_msgs-msg:submap_version instead.")
  (submap_version m))
