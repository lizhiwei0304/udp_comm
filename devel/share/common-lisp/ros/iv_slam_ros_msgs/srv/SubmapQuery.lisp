...
(cl:defmethod cl:initialize-instance :after ((m <SubmapQuery-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapQuery-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-srv:<SubmapQuery-request> is deprecated: use iv_slam_ros_msgs-srv:SubmapQuery-request instead.")))
...
(cl:defmethod submap_index-val ((m <SubmapQuery-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:submap_index-val is deprecated.  Use iv_slam_ros_msgs-srv:submap_index instead.")
  (submap_index m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SubmapQuery-request>)))
  ...
  "iv_slam_ros_msgs/SubmapQueryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SubmapQuery-request)))
  "Returns string type for a service object of type 'SubmapQuery-request"
  "iv_slam_ros_msgs/SubmapQueryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SubmapQuery-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapQuery-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-srv:<SubmapQuery-response> is deprecated: use iv_slam_ros_msgs-srv:SubmapQuery-response instead.")))

(cl:ensure-generic-function 'submap_version-val :lambda-list '(m))
(cl:defmethod submap_version-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:submap_version-val is deprecated.  Use iv_slam_ros_msgs-srv:submap_version instead.")
  (submap_version m))

(cl:ensure-generic-function 'cells-val :lambda-list '(m))
(cl:defmethod cells-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:cells-val is deprecated.  Use iv_slam_ros_msgs-srv:cells instead.")
  (cells m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:width-val is deprecated.  Use iv_slam_ros_msgs-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:height-val is deprecated.  Use iv_slam_ros_msgs-srv:height instead.")
  (height m))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:resolution-val is deprecated.  Use iv_slam_ros_msgs-srv:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'slice_pose-val :lambda-list '(m))
(cl:defmethod slice_pose-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:slice_pose-val is deprecated.  Use iv_slam_ros_msgs-srv:slice_pose instead.")
  (slice_pose m))

(cl:ensure-generic-function 'error_message-val :lambda-list '(m))
(cl:defmethod error_message-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:error_message-val is deprecated.  Use iv_slam_ros_msgs-srv:error_message instead.")
  (error_message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SubmapQuery-response>)))
  ...
  "iv_slam_ros_msgs/SubmapQueryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SubmapQuery-response)))
  "Returns string type for a service object of type 'SubmapQuery-response"
  "iv_slam_ros_msgs/SubmapQueryResponse")
