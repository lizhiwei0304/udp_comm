...
(cl:defmethod cl:initialize-instance :after ((m <WriteState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WriteState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-srv:<WriteState-request> is deprecated: use iv_slam_ros_msgs-srv:WriteState-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <WriteState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-srv:filename-val is deprecated.  Use iv_slam_ros_msgs-srv:filename instead.")
  (filename m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WriteState-request>)))
  ...
  "iv_slam_ros_msgs/WriteStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WriteState-request)))
  "Returns string type for a service object of type 'WriteState-request"
  "iv_slam_ros_msgs/WriteStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <WriteState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WriteState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iv_slam_ros_msgs-srv:<WriteState-response> is deprecated: use iv_slam_ros_msgs-srv:WriteState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WriteState-response>)))
  ...
  "iv_slam_ros_msgs/WriteStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WriteState-response)))
  "Returns string type for a service object of type 'WriteState-response"
  "iv_slam_ros_msgs/WriteStateResponse")
