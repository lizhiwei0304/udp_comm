...
(cl:defmethod cl:initialize-instance :after ((m <Traj_Node>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Traj_Node)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan2control_msgs-msg:<Traj_Node> is deprecated: use plan2control_msgs-msg:Traj_Node instead.")))

(cl:ensure-generic-function 'forward-val :lambda-list '(m))
(cl:defmethod forward-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:forward-val is deprecated.  Use plan2control_msgs-msg:forward instead.")
  (forward m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:id-val is deprecated.  Use plan2control_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:position-val is deprecated.  Use plan2control_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:orientation-val is deprecated.  Use plan2control_msgs-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'curvature-val :lambda-list '(m))
(cl:defmethod curvature-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:curvature-val is deprecated.  Use plan2control_msgs-msg:curvature instead.")
  (curvature m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Traj_Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan2control_msgs-msg:velocity-val is deprecated.  Use plan2control_msgs-msg:velocity instead.")
  (velocity m))
