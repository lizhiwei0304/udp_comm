...
(cl:defmethod cl:initialize-instance :after ((m <ModeCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ModeCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<ModeCmd> is deprecated: use control_msgs-msg:ModeCmd instead.")))
...
(cl:defmethod auto_mode-val ((m <ModeCmd>))
...
(cl:defmethod speed_mode-val ((m <ModeCmd>))
...
(cl:defmethod throttle_enable-val ((m <ModeCmd>))
...
(cl:defmethod brake_enable-val ((m <ModeCmd>))
...
(cl:defmethod steer_mode-val ((m <ModeCmd>))
...
(cl:defmethod gear_mode-val ((m <ModeCmd>))
