...
(cl:defmethod cl:initialize-instance :after ((m <VehicleState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<VehicleState> is deprecated: use control_msgs-msg:VehicleState instead.")))
...
(cl:defmethod child_frame_id-val ((m <VehicleState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:child_frame_id-val is deprecated.  Use control_msgs-msg:child_frame_id instead.")
  (child_frame_id m))
