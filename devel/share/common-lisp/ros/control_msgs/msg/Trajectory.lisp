...
(cl:defclass <Trajectory> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector control_msgs-msg:Traj_Node)
   :initform (cl:make-array 0 :element-type 'control_msgs-msg:Traj_Node :initial-element (cl:make-instance 'control_msgs-msg:Traj_Node))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<Trajectory> is deprecated: use control_msgs-msg:Trajectory instead.")))
...
(cl:defmethod points-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:points-val is deprecated.  Use control_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trajectory>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'control_msgs-msg:Traj_Node))
