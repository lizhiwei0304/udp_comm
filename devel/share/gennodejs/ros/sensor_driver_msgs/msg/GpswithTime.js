...
class GpswithTime {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GpswithTime
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GpswithTime
    let len;
    let data = new GpswithTime(null);
  ...
  static datatype() {
    ...
    return 'sensor_driver_msgs/GpswithTime';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4a9d103fb5b90d7927287e95289cb45b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GpswithTime(null);
